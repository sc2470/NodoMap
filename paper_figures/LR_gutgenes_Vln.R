...
NTR <- c("Casr","Ffar1","Ffar2","Ffar3","Ffar4","Gpbar1","Gpr35","Gpr84",
         "Gpr119","Gpr142","Hcar1","Hcar2","Sucnr1","Slc5a1","Slc5a2",
...
p[[16]]$labels$y <- "Tas1r1"
p[[17]]$labels$y <- "Tas1r2"
p[[18]]$labels$y <- "Tas1r3"
...
data.st <- SetIdent(data.st, value = "Position")
Stacked_VlnPlot(data.st, features = GHR, x_lab_rotate = TRUE)
Stacked_VlnPlot(data.st, features = NTR, x_lab_rotate = TRUE)
