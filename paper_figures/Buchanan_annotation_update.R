...
nodes <- data.frame(name=c(as.character(as.character(annotation_buchanan_connection$cluster_markers.x)),
...
annotation_buchanan_connection$IDsource <- match(annotation_buchanan_connection$cluster_markers.x,
                                                 nodes$name)-1
...
saveNetwork(sn, "Buchanan_sankey_plot.html", selfcontained = TRUE)
